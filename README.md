...
Increase the security of your Github Actions workflows using Drop-Drop! With Drop-Drop, you can easily control all your outbound network connections made from within your Github Actions workflows by defining a list of IPs and/or domains that you want to allow.
...
# If this action is not loaded first, it will not be able to see or block any requests that occurred prior to the action running.
- uses: hanshal101/drop-drop@v1
  with:
...
- This action currently only supports Github-hosted runners on Ubuntu (`ubuntu-latest`, `ubuntu-22.04` and `ubuntu-24.04`).
...
If you need support or have any feedback to share, reach out to the repository maintainers. And if you find Drop-Drop useful, please leave a star ⭐️.
